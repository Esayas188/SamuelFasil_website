    ...
    return ( 
        ...
        <div className=" md:min-h-[800px] min-h-[600px] bg-[#b2b4b2] grid md:grid-cols-2 sm:mb-[80px]" style={{ maxWidth: '1800px', margin: '0 auto' }}>
            <div className="grid grid-cols-5   md:px-0" >
                <div className='text-[#b2b4b2] flex flex-col justify-end pb-[60px] items-center bg-[#121212] col-span-1' >
                ...
                <p className='text-[#121212] tracking-normal md:leading-[70px] text-4xl sm:text-5xl font-extrabold max-w-[325px]'>HI, I'M SAMUEL FASIL, <span className=' text-[#b31358]'><TypingText/></span></p>
