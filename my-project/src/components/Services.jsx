...
const Services = () => {
    return ( 
        ...
        <div className='py-[60px]' id='skills'>
            <p className=' text-2xl font-bold text-[#07264a] text-center pb-8 md:pb-0'>SERVICES</p>
            <div className="grid md:grid-cols-2 gap-[20px] md:gap-0 px-[60px] lg:px-[100px] text-[#07264a] min-h-screen  ">
            ...
            <div class=" w-full max-w-md bg-[#07264a] text-[#b2b4b2] rounded-lg  p-6">
                ...
                <textarea
                    name="message"
                    class="bg-gray-700 text-gray-200 border-0 rounded-md p-2 mb-auto md:mb-auto w-full md:h-auto md:min-h-[100px] md:max-h-[100px] md:flex-grow md:flex-shrink md:flex-auto  md:focus:outline-none:focus:ring-blue-md:focus:border-transparent transition ease-in-out duration-fastest"
                    placeholder="Message"
                ></textarea>

                <button
                    type="submit"
                    class="bg-gradient-to-r from-[rgba(179,19,88,0.6)] to-[rgba(179,19,88,0.8)]  font-bold py-2 px-4 rounded-md mt-4  transition ease-in-out duration-150"
                >
                    Submit
                </button>
                </form>
